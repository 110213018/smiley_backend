...
INSERT INTO `analysis` (`id`, `diary_id`, `date`, `sadness`, `disgust`, `like`, `anger`, `happiness`, `other`) VALUES
(3, 3, '2024-07-15', 0, 0, 0, 0, 100, 0);
...
(10000, 2557, '5275', '2024-07-25');

--
-- 觸發器 `diaries`
--
DELIMITER $$
CREATE TRIGGER `insert` AFTER INSERT ON `diaries` FOR EACH ROW BEGIN
	INSERT INTO trigger_bert (trigger_time) VALUES (CURRENT_TIMESTAMP);
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `update` AFTER UPDATE ON `diaries` FOR EACH ROW BEGIN
	INSERT INTO trigger_bert (trigger_time) VALUES (CURRENT_TIMESTAMP);
END
$$
DELIMITER ;
...
--
-- 資料表結構 `diaries_mon_ang`
--

CREATE TABLE `diaries_mon_ang` (
  `id` int(11) NOT NULL,
  `diary_id` int(11) NOT NULL,
...
--
-- 資料表索引 `diaries_mon_ang`
--
ALTER TABLE `diaries_mon_ang`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `diaries`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '每一篇日記的 id', AUTO_INCREMENT=10001;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `diaries_mon_ang`
--
ALTER TABLE `diaries_mon_ang`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
